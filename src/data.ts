...
const commonIncluded = [
  ...
  "Full-board handpicked accommodation",
  "Flying Doctor emergency evacuation cover",
  "Airport transfers and purified water",
];
...
export const safaris: Safari[] = [
  ...
  },
  {
    ...
    included: [...commonIncluded, "Selected premium drinks and laundry"],
    excluded: commonExcluded,
  ...
  },
  {
    ...
    included: [...commonIncluded, "Private family vehicle throughout"],
    excluded: commonExcluded,
  ...
  },
  {
    ...
    included: [...commonIncluded, "Internal scheduled flights", "Private celebration dinner"],
    excluded: commonExcluded,
  ...
  },
  {
    ...
    included: [...commonIncluded, "Photography vehicle with charging stations"],
    excluded: [...commonExcluded, "Camera equipment"],
  ...
  },
  {
    ...
    included: [...commonIncluded, "Armed walking ranger"],
    excluded: commonExcluded,
    availability: ["Jun", "Jul", "Aug", "Sep", "Oct"],
    coordinates: [52, 62],
  },
